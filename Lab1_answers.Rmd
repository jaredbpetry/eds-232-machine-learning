...
*Question* Use a combination of dplyr::filter() and stringr::str_detect() to achieve what we want.
...
*Question:* Group the pumpkins into groups based on the month column and then find the mean price for each month. Plot the results with a bar plot.

Hint: use dplyr::group_by() %\>% summarize()

```{r}
# Find the average price of pumpkins per month
new_pumpkins %>% group_by(month) %>% summarise(mean_price = mean(price))
```
...
# Find the correlation between the day and the price
